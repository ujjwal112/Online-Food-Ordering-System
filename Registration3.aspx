<%@ Page Title="" Language="C#" MasterPageFile="~/Visitor.master" AutoEventWireup="true" CodeFile="Registration3.aspx.cs" Inherits="Registration3" %>
        ...
        <div class="box">
            ...
            <form>
                ...
                <div class="inputbox">
                    ...
                    <div class="check">
                  DOCUMENT TYPE<asp:RadioButtonList ID="RadioButtonList2" runat="server" RepeatDirection="Horizontal">
