<%@ Page Title="" Language="C#" MasterPageFile="~/Visitor.master" AutoEventWireup="true" CodeFile="Registration2.aspx.cs" Inherits="Registration2" %>
        ...
        <div class="box">
           ...
           <form>
                ...
                <div class="inputbox">
                    ...
                    <div class="check">
                  DOCUMENT TYPE<asp:CheckBoxList ID="CheckBoxList1" runat="server" RepeatDirection="Horizontal" required="">
               ...
               <div class="check">
                  VEHICLE TYPE<asp:RadioButtonList ID="RadioButtonList2" runat="server" RepeatDirection="Horizontal">
